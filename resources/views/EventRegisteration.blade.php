            ...
            <div class="row box">
              ...
              <div id='container_3'  class="col-md-5 mr-0 bg-white text-warning">
                <center><p class="h4 mb-4">Registeration</p></center>
                  ...
                  <form action="{route('')}" method="GET" class="p-4 text-warning">
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" class="form-control" title="الرجاء ادخل  رقم الهاتف" placeholder="01*********" pattern="[0-9]{11}" required>
                    </div>
                    <div class="row">
                    <div class="col-md-6">
